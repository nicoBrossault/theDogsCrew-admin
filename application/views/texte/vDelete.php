	...
	<div class="col s8 m5 offset-s2 offset-m4">
		<div class="card hoverable">
			<div class="card-title teal darken-1 white-text" style="text-align:center; padding:2%">
				<?php if(!isset($msg)):?>
					<b>Supprimer le texte "<?=$texte->getLibelle()?>" ?</b>
				<?php else : echo $msg?>
				<?php endif; ?>
			</div>
			<div class="card-content center-align">
				<?php if(!isset($msg)):?>
					...
					<a href="<?=base_url('cTexte')?>" class="btn waves-effect waves-light cancel" id="annuler">
						Annuler
						<i class="material-icons left">highlight_off</i>
					</a>
				<?php else : ?>
					<a href="<?=base_url('cTexte')?>" class="btn waves-effect waves-light">
						Ok
