...
<div class="card col s10 m10 l10 offset-s1 offset-m1 offset-l1" style="padding:2%;">
	...
	<?php	
		...
		echo form_hidden('idGalerie',$imgGalerie->getIdimage());
		echo form_hidden('idUser',$imgGalerie->getIduser()->getIduser());
	?>
	...
	<?php 
		$titre= array(
				'name'=>'titre',
				'id'=>'titre',
				'placeholder'=>utf8_encode($imgGalerie->getTitre()),
				'value'=>utf8_encode($imgGalerie->getTitre()),
				'required'=>'required',
				);
...
<?php	
	$texte= array(
			...
			'value'=> utf8_encode($imgGalerie->getDescription()),
			'required'=>'required',
			'cols' => '40',
			'rows' => '40',
	);
